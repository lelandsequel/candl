...
export default function WhatWeBuildPage() {
    return (
        <main className="flex-1 w-full">
            <ImmersiveSection backgroundImage="/data-center.png" overlayOpacity={0.8} className="min-h-[80vh]">
                ...
                <div className="mt-12 grid gap-6 lg:grid-cols-2 items-start">
                    ...
                    {/* Digital Consulting Section - Highlighting the contrast */}
                    <div className="rounded-2xl border border-sky-900/40 bg-[#0B1121]/80 backdrop-blur-md overflow-hidden relative group shadow-2xl shadow-sky-900/10">
