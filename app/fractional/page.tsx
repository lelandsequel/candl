    ...
    return (
        <main className="flex-1 w-full relative min-h-screen">
            ...
            <div className="mx-auto w-full max-w-6xl px-4 py-16 md:px-6 lg:px-8">
                ...
                {/* What This Is */}
                <section className="mt-16 rounded-2xl border border-slate-800 bg-slate-950/60 p-10">
                ...
                {/* What This Is Not */}
                <section className="mt-8 rounded-2xl border border-slate-800 bg-slate-950/60 p-10">
                    <h2 className="text-2xl font-semibold text-slate-50 md:text-3xl">
                        What This Is Not
                    </h2>
                ...
                {/* CTA */}
                <section className="mt-16 rounded-2xl border border-slate-800 bg-slate-950/60 p-10 text-center">
                    <h2 className="text-2xl font-semibold text-slate-50 md:text-3xl">
