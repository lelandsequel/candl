  ...
  return (
    <>
      ...
      <main className="flex-1 w-full">
        <ImmersiveSection
          backgroundImage="/oilfield-painting.jpg"
          overlayOpacity={0.7}
        >
          {/* Hero */}
          <div className="grid gap-10 md:grid-cols-12 md:items-start md:place-content-center">
            <div className="md:col-span-12 lg:col-span-7">
              ...
              <p className="mt-6 max-w-2xl text-pretty text-base leading-relaxed text-slate-200 md:text-lg">
                We untangle <span className="font-semibold text-white">operations</span>,{" "}
                <span className="font-semibold text-white">process</span>, and{" "}
                <span className="font-semibold text-white">finance</span> by building the systems that actually run the
                business — not strategy theater, not decks you can't implement.
              </p>
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <Link
                  href={CTA_LINK}
                  className="inline-flex items-center gap-2 rounded-full border border-sky-500/50 bg-sky-500/10 px-6 py-3 text-sm font-medium text-sky-100 hover:bg-sky-500/20 backdrop-blur-md shadow-lg shadow-sky-900/20"
                >
                ...
                <Link
                  href="/jourdanlabs"
                  className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-6 py-3 text-sm font-medium text-slate-100 hover:bg-white/10 backdrop-blur-sm"
                >
                  <span>JourdanLabs</span>
                  <span aria-hidden>→</span>
                </Link>
              </div>
          ...
          <div className="mx-auto w-full max-w-6xl px-4 md:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <h2 className="mt-3 text-3xl font-semibold text-slate-50">We're not career consultants.</h2>
                <p className="mt-4 text-base leading-relaxed text-slate-300">
                  We've cut our teeth in real operations: oil fields, terminals, logistics, construction, and the
                  financial controls that keep companies alive. We build solutions that survive contact with reality.
                </p>

                <div className="mt-8 rounded-xl border border-amber-500/20 bg-amber-500/5 p-6 backdrop-blur-sm">
                  <p className="text-xs font-semibold uppercase tracking-[0.18em] text-amber-200">Fit check</p>
          ...
          <div className="mx-auto w-full max-w-6xl px-4 md:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <h2 className="mt-3 text-3xl font-semibold text-slate-50">Digital Systems & Search Infrastructure</h2>
                <p className="mt-4 text-base leading-relaxed text-slate-300">
                  Some problems don't live on job sites or balance sheets — but they still need to run in production.
                </p>
                <p className="mt-4 text-base leading-relaxed text-slate-300">
                  We design and build <strong>digital infrastructure</strong> for companies that need clarity,
                  durability, and leverage — not marketing noise.
                </p>
                ...
                <p className="mt-6 text-sm italic text-slate-500 border-l-2 border-slate-800 pl-4">
                  Same operator discipline: rules first, structure before scale, systems teams can actually run.
                </p>
              </div>

              <div className="rounded-2xl border border-sky-900/30 bg-sky-950/10 p-8">
                <h3 className="text-xl font-semibold text-sky-100">SEO OS™ — Search Built Like Infrastructure</h3>
                <p className="mt-4 text-sm leading-relaxed text-sky-200/80">
                  SEO OS is our framework for long-term search visibility without shortcuts, churn, or dependency on
                  ongoing busywork.
                </p>
                <p className="mt-4 text-sm leading-relaxed text-sky-200/80">
                  We design search as infrastructure:
                </p>
                ...
                <div className="mt-8 pt-8 border-t border-sky-900/30">
                  <Link
                    href="/digital"
                    className="inline-flex items-center gap-2 text-sm font-medium text-sky-300 hover:text-sky-200 transition-colors group"
                  >
        ...
        <section className="bg-[#0B1121] py-24 border-t border-slate-800/50">
          <div className="mx-auto w-full max-w-4xl px-4 text-center">
            ...
            <h2 className="mt-4 text-3xl font-semibold text-slate-50 md:text-5xl">Let's build something real.</h2>
            <p className="mt-6 text-lg leading-relaxed text-slate-300">
              Stop admiring the problem. We'll define the system, build the tools, and take control of your operations.
            </p>
