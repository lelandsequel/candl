        ...
        <footer className="border-t border-slate-200 bg-slate-100">
            <div className="mx-auto flex w-full max-w-6xl flex-col items-start justify-between gap-3 px-4 py-8 text-xs text-slate-500 md:flex-row md:items-center md:px-6 lg:px-8">
                ...
                <div className="flex flex-wrap gap-3">
                    <Link href="/what-we-build" className="text-sm text-slate-600 hover:text-slate-900">
                        Build
                    </Link>
                    <Link href="/how-we-work" className="text-sm text-slate-600 hover:text-slate-900">
                        Work
                    </Link>
                    <Link href="/case-work" className="text-sm text-slate-600 hover:text-slate-900">
                        Cases
                    </Link>
                    <Link href="/construction" className="text-sm text-slate-600 hover:text-slate-900">
                        Construction
                    </Link>
